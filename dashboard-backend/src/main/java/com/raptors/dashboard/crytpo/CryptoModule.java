...
public class CryptoModule {
    ...
    public static byte[] encryptAes(byte[] keyBytes, byte[] plaintextBytes) throws Exception {
    ...
    public static byte[] decryptAes(byte[] keyBytes, byte[] ciphertext) throws Exception {
        Cipher cipher = Cipher.getInstance(AES_CBC_PKCS_7_PADDING);
